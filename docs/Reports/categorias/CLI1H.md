# 📄 **Gestión y envío de Avisos de Cobro**

- Dedicada para la gestión y envío de avisos de cobro por correo electrónico a clientes.
...
- Se tiene la posibilidad de guardar y cargar vistas personalizadas. (Filtros precargados que podrían ser recurrentes para el usuario)
...
### 📨 **3. Configuración y envío de correos**
...
6. **Envío individual:** Puede enviar el aviso uno a uno usando el botón de acción en la parte izquierda de cada registro.
7. **Envío masivo:** Al hacer clic en "Enviar pendientes", se enviarán los avisos a todos los registros con estado pendiente (y correo configurado).
8. Si el envío es exitoso, al cliente le llegará un correo con un formato de PDF detallando los pagos pendientes.
9. **Teléfono personalizado:** Si necesita mostrar un teléfono distinto al general, puede escribirlo en la pantalla previa del reporte antes de abrir la gestión. Ese valor también se incorpora al correo HTML enviado al cliente.
...
### 🧾 **4. Exportación y Generación de PDF**
